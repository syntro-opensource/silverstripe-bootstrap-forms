...
class RenderFormFieldsTest extends FunctionalTest
{
    ...
    public function testReadonlyFieldRendering()
    {
        ...
        $this->assertStringContainsString('<input type="text" name="readonlyfield" value="&lt;i&gt;(&#039;none&#039;)&lt;/i&gt;" class="readonly form-control readonlyfieldextraclass" id="Form_Form_readonlyfield" readonly="readonly" disabled/>', $body);
    }
    ...
    /**
     * testNumericFieldRendering - description
     *
     * @return void
     */
