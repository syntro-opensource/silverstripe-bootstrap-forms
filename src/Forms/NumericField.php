...
use SilverStripe\Forms\NumericField as BackendNumericField;

/**
 * Frontend NumericField
 * @author Patrick Côté <git@ptct.ch>
 */
class NumericField extends BackendNumericField
{
    use HolderClass;
